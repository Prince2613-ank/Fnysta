...
import '../../../news/presentation/pages/news_screen.dart'; // ⭐ Correctly import NewsScreen
import '../../../calculator/presentation/pages/more_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  // ⭐ Replace MarketScreen with NewsScreen
  static const List<Widget> _widgetOptions = <Widget>[
    _HomeContent(), // Index 0
    AstrologyScreen(), // Index 1
    CommunityScreen(), // Index 2
    NewsScreen(), // Index 3
    MoreScreen(), // Index 4
  ];
...
// ⭐ Your original home screen content, now in its own widget
      ...
      child: SizedBox(
        ...
        child: Row(
          ...
          children: [
            Flexible(
              flex: 5,
              child: _buildPlatformCard('Community', 'assets/community1.png',
                  borderRadius: 8.0),
            ),
            ...
            Flexible(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: _buildPlatformCard(
                        'Stock Market', 'assets/stockmarket1.png',
                        borderRadius: 1.0),
                  ),
                ],
              ),
